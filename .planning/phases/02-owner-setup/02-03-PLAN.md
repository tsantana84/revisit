...
<task type="auto">
  ...
  <action>
    ...
    **All text in pt-BR**
    ...
    Note: The navigation link to `/dashboard/owner/settings` ("Configuracoes") is already created in the owner layout by Plan 02-01. Do NOT modify `src/app/dashboard/owner/layout.tsx` — it is owned by Plan 02-01.
