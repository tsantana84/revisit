...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/owner/team', label: 'Equipe' },
  { href: '/dashboard/owner/settings', label: 'Configurações' },
  { href: '/dashboard/owner/analytics', label: 'Análises' },
  { href: '/dashboard/owner/customers', label: 'Clientes' },
  { href: '/dashboard/owner/logs', label: 'Registros' },
]
